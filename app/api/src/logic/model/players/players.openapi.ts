...
export const PLAYERS_OPENAPI_SCHEMAS: Record<string, unknown> = {
...
export const PLAYERS_OPENAPI_ROUTES: Record<string, OpenAPIRoute> = {
  ...
  PLAYED_WITH: {
    ...
    summary:
      "Get teammate impact stats — average points when playing with each teammate",
    tags: ["Players"],
